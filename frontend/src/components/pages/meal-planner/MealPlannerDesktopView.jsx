...
function MealPlannerDesktopView({
  currentWeekDates,
  viewMode,
  plannedMeals,
  expandedDays,
  ...
  const renderDayCard = (date) => {
    ...
    return (
      <div 
        ...
        data-day-card
      >
        {/* Day Header - Desktop/Tablet layout */}
  ...
  return (
    <>
      ...
      {/* Calendar Grid - Desktop optimized multi-column layout */}
...
export default MealPlannerDesktopView;
