...
const PrivacyPolicyPage = () => {
  ...
  const pStyle = "text-gray-300 leading-relaxed mb-4";
  ...
  return (
    <div className="page-container max-w-5xl my-10">
      ...
      <p className={`text-center text-gray-400 mb-12 text-sm`}>Last Updated: {lastUpdatedDate}</p>

      <div className="max-w-3xl mx-auto mb-8 bg-gray-800 p-6 sm:p-8 shadow-xl rounded-lg">
      ...
      <div className="max-w-3xl mx-auto mb-8 bg-gray-800 p-6 sm:p-8 shadow-xl rounded-lg">
        ...
        <ul className="list-disc list-inside text-gray-300 leading-relaxed mb-4 pl-4">
      ...
      <div className="max-w-3xl mx-auto mb-8 bg-gray-800 p-6 sm:p-8 shadow-xl rounded-lg">
        <div className="flex items-center mb-4">
          <MdOutlineShare className="h-7 w-7 mr-3 text-indigo-400" />
